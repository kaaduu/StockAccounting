...
public class MainWindow extends javax.swing.JFrame
{
  ...
  /**
   * Date cell editor using JCalendar. We do not use JCalendar builtin date editor,
   * since it is not configurable. And we need some "specialities" (like remembering last date) anyway.
   */
  private class DateChooserCellEditor extends javax.swing.AbstractCellEditor implements javax.swing.table.TableCellEditor
  {
  ...
  private boolean checkModified()
  {
    if (transactions.isModified()) {
      int res = JOptionPane.showConfirmDialog(this,"Datový soubor byl modifikován. Přejete si jej uložit?","Otázka",JOptionPane.YES_NO_CANCEL_OPTION);
  ...
  private void initComponents() {
    ...
    dcFrom = new com.n1logic.date.DatePicker();
    jLabel3 = new javax.swing.JLabel();
    dcTo = new com.n1logic.date.DatePicker();
    ...
    cbCurrencies.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
    ...
    cbType.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "CP", "Derivát", "Transformace", "Dividenda", "Cash" }));
    ...
    dcTo.setMinimumSize(new java.awt.Dimension(70, 20));
    ...
    miOpen.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_O, java.awt.event.InputEvent.SHIFT_MASK));
  ...
  {//GEN-HEADEREND:event_miImportActionPerformed
    fileChooser.setDialogTitle("Importovat soubor");
    ...
    if (res == JFileChooser.APPROVE_OPTION) {
      ...
      Settings.setImportDirectory(fileChooser.getCurrentDirectory().getAbsolutePath());
      Settings.save();

      importWindow.startImport(fileChooser.getSelectedFile(),startDate);
  ...
  private boolean saveAsTransactions()
  {
    ...
    if (res == JFileChooser.APPROVE_OPTION) {
      ...
      File file = fileChooser.getSelectedFile();
      if (file.exists()) {
        if (JOptionPane.showConfirmDialog(this,"Soubor "+file.getAbsolutePath()+" již existuje, chcete jej přepsat?","Přepsat soubor?",JOptionPane.YES_NO_OPTION) != JOptionPane.YES_OPTION) return false;
      }
  ...
  {
    fileChooser.setDialogTitle("Uložit vyfiltrované transakce");
  ...
  public boolean saveAction()
  {
    ...
    if (fl == null) return saveAsTransactions();
    else return saveTransactions(fl);
  }
  ...
  public void refreshCurrenciesCombo()
  {
    ...
    DefaultComboBoxModel model = (DefaultComboBoxModel)cbCurrencies.getModel();
    ...
    if (!czkEntered) model.addElement("CZK");
  ...
  private com.n1logic.date.DatePicker dcFrom;
  private com.n1logic.date.DatePicker dcTo;
